...
{
    out << product.ID << "\t" << setw(20) << product.Name << "\t" << setw(20) << product.Manufacturer
        << "\t\t" << setw(2) << product.Size << "\t" << setw(15) << product.Type << "\t" << setw(20) << setprecision(3) << fixed << product.Price << "\t" << setw(10) << product.Amount << endl;
    return out;
}
